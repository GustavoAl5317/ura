...
export const config = {
  ...
  zabbix: {
    ...
    searchPatterns: opt(
      ...
      'Queda de Clientes na CTO|Queda de sessões na CTO| - OFFLINE|Queda total no número de sessões PPPoE|ALERTA: cto off|Queda da Interface|Interface|POP|PoE|Energia|Power|DSE|Link|Roteador|ONU|Equipamento',
